...
<%
	...
	List<suggestDto> list = (List<suggestDto>) request.getAttribute("list");
   ...
   <section class="bbs_section layout_padding">
      <div class="container_padding" align="center">
			...
			<div class="deltbcontainer">
				<table id="tblist">
					<col width="100"><col width="120"><col width="400"><col width="500">
						<tr class="thtitle">
...
$("#schbtn").click(function() {
	...
	location.href="./admincont?work=sug_qsearch&need="+need+"&fneed="+fneed+"&pageNumber=0&how="+how;
...
function goPage(data) {
	//console.log(data);
	if('<%=need%>'==""){
		location.href="./admincont?work=sug_moveQnadel&pageNumber="+data+"&how="+how;
	}else{
		location.href="./admincont?work=sug_qsearch&need=<%=need%>&fneed=<%=fneed%>&pageNumber="+data+"&how="+how;
	}
	
}
function fPage(){
	location.href="./admincont?work=sug_moveQnadel&pageNumber="+0+"&how="+how;
}
function lpage(){
	//console.log(<%=tpage%>);
	location.href="./admincont?work=sug_moveQnadel&pageNumber=<%=tpage-1%>&how="+how;
}
function prevpage(data) {
	location.href="./admincont?work=sug_moveQnadel&pageNumber="+((data*5)-5)+"&how="+how;
}
...
function delBtn() {
	...
	//console.log(a);
	 $.ajax({
			...
			type:"get", 
			datatype:"text",
			data:"work=sug_delchklist&chklist="+a, 
